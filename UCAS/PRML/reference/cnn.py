...
x_train_path=r'../homework/data/train-images-idx3-ubyte.gz'
y_train_path=r'../homework/data/train-labels-idx1-ubyte.gz'
x_test_path=r'../homework/data/t10k-images-idx3-ubyte.gz'
y_test_path=r'../homework/data/t10k-labels-idx1-ubyte.gz'
